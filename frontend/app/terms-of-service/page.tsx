  ...
  return (
    <div className="min-h-screen bg-white pt-24 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-heading font-bold text-[#1A1A1A] dark:text-white mb-4">Terms of Service</h1>
        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-10">
            <h2 className="text-2xl font-heading font-bold text-[#1A1A1A] dark:text-white mb-4">1. Agreement to Terms</h2>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-heading font-bold text-[#1A1A1A] dark:text-white mb-4">2. Services Description</h2>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-heading font-bold text-[#1A1A1A] dark:text-white mb-4">3. Quotations and Pricing</h2>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-heading font-bold text-[#1A1A1A] dark:text-white mb-4">4. Project Engagement</h2>
            
            <h3 className="text-xl font-semibold text-[#1A1A1A] dark:text-white mt-6 mb-3">4.1 Consultation</h3>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-[#1A1A1A] dark:text-white mt-6 mb-3">4.2 Contract Formation</h3>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-[#1A1A1A] dark:text-white mt-6 mb-3">4.3 Payment Terms</h3>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-heading font-bold text-[#1A1A1A] dark:text-white mb-4">5. Warranty and Support</h2>
            
            <h3 className="text-xl font-semibold text-[#1A1A1A] dark:text-white mt-6 mb-3">5.1 Installation Warranty</h3>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-[#1A1A1A] dark:text-white mt-6 mb-3">5.2 Equipment Warranty</h3>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-[#1A1A1A] dark:text-white mt-6 mb-3">5.3 Extended Support</h3>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-heading font-bold text-[#1A1A1A] dark:text-white mb-4">6. Client Responsibilities</h2>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-heading font-bold text-[#1A1A1A] dark:text-white mb-4">7. Intellectual Property</h2>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-heading font-bold text-[#1A1A1A] dark:text-white mb-4">8. Website Use</h2>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-heading font-bold text-[#1A1A1A] dark:text-white mb-4">9. Limitation of Liability</h2>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-heading font-bold text-[#1A1A1A] dark:text-white mb-4">10. Cancellation and Refunds</h2>
            
            <h3 className="text-xl font-semibold text-[#1A1A1A] dark:text-white mt-6 mb-3">10.1 Client Cancellation</h3>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-[#1A1A1A] dark:text-white mt-6 mb-3">10.2 LEXA Cancellation</h3>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-heading font-bold text-[#1A1A1A] dark:text-white mb-4">11. Force Majeure</h2>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-heading font-bold text-[#1A1A1A] dark:text-white mb-4">12. Dispute Resolution</h2>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-heading font-bold text-[#1A1A1A] dark:text-white mb-4">13. Governing Law</h2>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-heading font-bold text-[#1A1A1A] dark:text-white mb-4">14. Changes to Terms</h2>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-heading font-bold text-[#1A1A1A] dark:text-white mb-4">15. Contact Information</h2>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-heading font-bold text-[#1A1A1A] dark:text-white mb-4">16. Severability</h2>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
