      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-600 leading-relaxed">Standard payment terms are:</p>
            <ul className="list-disc pl-6 text-gray-600 space-y-2 mt-3">
          ...
          <section className="mb-10">
            ...
            <div className="bg-gray-50 p-6 rounded-xl mt-4">
              ...
              <p className="text-gray-600 mt-2">Email: legal@lexalifestyle.com</p>
              <p className="text-gray-600">Phone: +971 4 267 0470</p>
              <p className="text-gray-600 mt-2">TRN: 104472899400003</p>
            </div>
          </section>
