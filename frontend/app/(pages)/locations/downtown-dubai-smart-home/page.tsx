...
export default function DowntownDubaiPage() {
  const cms = useCms('page_geo_(pages)_locations_downtown_dubai_smart_home', null)
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 pt-20">
        ...
        <div className="container mx-auto px-8 lg:px-16">
          <div className="max-w-4xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 mb-8">LEXA Lifestyle specializes in luxury apartment and penthouse automation in Downtown Dubai. Over 200 properties automated in Burj Khalifa, Address residences, and surrounding towers.</p>
            </motion.div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-16">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">Specialized in finished apartment automation:</p>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-gray-900 pl-4">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">4,500 sq ft | AED 320,000</div>
                  ...
                  <div className="border-l-4 border-gray-900 pl-4">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">2,200 sq ft | AED 120,000</div>
                  ...
                  <div className="border-l-4 border-gray-900 pl-4">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">Any Size | AED 85,000+</div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <div className="text-gray-600 dark:text-gray-400 dark:text-gray-400">Downtown Properties Automated</div>
              </div>
              <div className="text-center">
                <DollarSign className="inline-block mb-4" size={40} />
                <div className="text-3xl font-bold mb-2">AED 150K</div>
                <div className="text-gray-600 dark:text-gray-400 dark:text-gray-400">Average Apartment Project</div>
              </div>
              <div className="text-center">
                <Clock className="inline-block mb-4" size={40} />
                <div className="text-3xl font-bold mb-2">3-5 Weeks</div>
                <div className="text-gray-600 dark:text-gray-400 dark:text-gray-400">Installation Timeline</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="container mx-auto px-8 lg:px-16 text-center">
          ...
          <Link href="/contact" className="inline-block bg-white text-gray-900 dark:text-white px-8 py-4 text-lg font-semibold hover:bg-gray-100 dark:bg-gray-800 transition-colors">Schedule Consultation</Link>
        </div>
      </section>
    </div>
  )
