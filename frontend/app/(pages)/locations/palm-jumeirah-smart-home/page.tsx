...
export default function PalmJumeirahPage() {
  const cms = useCms('page_geo_(pages)_locations_palm_jumeirah_smart_home', null)
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 pt-20">
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="container mx-auto px-8 lg:px-16 text-center">
          ...
          <Link href="/contact" className="inline-block bg-white text-gray-900 dark:text-white px-8 py-4 text-lg font-semibold hover:bg-gray-100 dark:bg-gray-800 transition-colors">Private Design Session</Link>
        </div>
      </section>
    </div>
  )
