              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-gray-900 pl-4">
                    ...
                    <div className="text-sm text-gray-600">12,000 sq ft | AED 850,000</div>
                  ...
                  <div className="border-l-4 border-gray-900 pl-4">
                    ...
                    <div className="text-sm text-gray-600">8,500 sq ft | AED 520,000</div>
                  ...
                  <div className="border-l-4 border-gray-900 pl-4">
                    ...
                    <div className="text-sm text-gray-600">Cinema Room | AED 320,000</div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg mb-16">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Control4 or Crestron systems controlling lighting, climate, shades, security, and entertainment</p>
                </div>
                <div>
                  <div className="font-semibold mb-2">Lutron Lighting</div>
                  <p className="text-sm text-gray-600">Keypads, dimmers, and architectural lighting control throughout villa</p>
                </div>
                <div>
                  <div className="font-semibold mb-2">Home Theaters</div>
                  <p className="text-sm text-gray-600">Dedicated cinema rooms with Dolby Atmos surround sound</p>
                </div>
                <div>
                  <div className="font-semibold mb-2">Multi-Room Audio</div>
                  <p className="text-sm text-gray-600">Sonos, KEF, or Control4 audio in every room and outdoor areas</p>
                </div>
                <div>
                  <div className="font-semibold mb-2">Security Integration</div>
                  <p className="text-sm text-gray-600">CCTV, access control, smart locks, and alarm systems</p>
                </div>
                <div>
                  <div className="font-semibold mb-2">Network Infrastructure</div>
                  <p className="text-sm text-gray-600">Enterprise-grade networking for reliable smart home operation</p>
                </div>
              </div>
            </div>
