        ...
        <div className="container mx-auto px-8 lg:px-16">
          <div className="max-w-4xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              ...
              <p className="text-xl text-gray-600 mb-8">LEXA Lifestyle is Emirates Hills&apos; trusted smart home partner. Over 150 luxury villas automated with Control4, Crestron, and Lutron systems.</p>
            </motion.div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-16">
              ...
              <h3 className="h3 uppercase mb-4">LOCAL EXPERTISE</h3>
                <p className="text-gray-600 mb-4">We understand Emirates Hills properties intimately:</p>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-gray-900 pl-4">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400">12,000 sq ft | AED 850,000</div>
                  ...
                  <div className="border-l-4 border-gray-900 pl-4">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400">8,500 sq ft | AED 520,000</div>
                  ...
                  <div className="border-l-4 border-gray-900 pl-4">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400">Cinema Room | AED 320,000</div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg mb-16">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">Control4 or Crestron systems controlling lighting, climate, shades, security, and entertainment</p>
                </div>
                <div>
                  <div className="font-semibold mb-2">Lutron Lighting</div>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Keypads, dimmers, and architectural lighting control throughout villa</p>
                </div>
                <div>
                  <div className="font-semibold mb-2">Home Theaters</div>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Dedicated cinema rooms with Dolby Atmos surround sound</p>
                </div>
                <div>
                  <div className="font-semibold mb-2">Multi-Room Audio</div>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Sonos, KEF, or Control4 audio in every room and outdoor areas</p>
                </div>
                <div>
                  <div className="font-semibold mb-2">Security Integration</div>
                  <p className="text-sm text-gray-600 dark:text-gray-400">CCTV, access control, smart locks, and alarm systems</p>
                </div>
                <div>
                  <div className="font-semibold mb-2">Network Infrastructure</div>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Enterprise-grade networking for reliable smart home operation</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              <div className="text-center">
                ...
                <div className="text-gray-600 dark:text-gray-400">Emirates Hills Villas Completed</div>
              </div>
              <div className="text-center">
                <DollarSign className="inline-block mb-4" size={40} />
                <div className="text-3xl font-bold mb-2">AED 350K+</div>
                <div className="text-gray-600 dark:text-gray-400">Average Project Investment</div>
              </div>
              <div className="text-center">
                <Clock className="inline-block mb-4" size={40} />
                <div className="text-3xl font-bold mb-2">10-14 Weeks</div>
                <div className="text-gray-600 dark:text-gray-400">Typical Installation Timeline</div>
              </div>
            </div>
          </div>
        </div>
