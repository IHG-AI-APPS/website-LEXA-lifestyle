            ...
            >
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                />
              </div>
            </motion.div>
          </div>
            ...
            {filteredTerms.map((section, sectionIndex) => (
              ...
              >
                <div className="flex items-center gap-4 mb-8 pb-4 border-b-2 border-gray-900">
                  <span className="text-6xl font-bold text-gray-900">{section.letter}</span>
                </div>

                <div className="space-y-8">
                  {section.terms.map((item, index) => (
                    <div key={index} className="group">
                      <h3 className="text-2xl uppercase font-semibold text-gray-900 mb-2">
                        {item.term}
                      </h3>
