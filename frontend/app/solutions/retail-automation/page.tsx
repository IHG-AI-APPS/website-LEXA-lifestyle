                ...
                return (
                  <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.1 }} viewport={{ once: true }} className="bg-white p-8 border-2 border-gray-200 hover:border-[#1A1A1A] transition-all">
                    <div className="flex items-start gap-4">
                      <div className="p-3 bg-gray-50"><Icon className="h-6 w-6 text-[#1A1A1A]" /></div>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 text-center max-w-4xl">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
              <div className="p-6 bg-gray-50"><div className="text-4xl font-bold text-[#1A1A1A]">35%</div><div className="text-sm text-gray-600">Energy Savings</div></div>
              <div className="p-6 bg-gray-50"><div className="text-4xl font-bold text-[#1A1A1A]">22%</div><div className="text-sm text-gray-600">Sales Increase</div></div>
              <div className="p-6 bg-gray-50"><div className="text-4xl font-bold text-[#1A1A1A]">40%</div><div className="text-sm text-gray-600">Faster Checkout</div></div>
              <div className="p-6 bg-gray-50"><div className="text-4xl font-bold text-[#1A1A1A]">60%</div><div className="text-sm text-gray-600">Loss Prevention</div></div>
            </div>
          </div>
        </section>
      </div>
