          ...
          <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="grid md:grid-cols-3 gap-4 text-left">
              <Link href="/services" className="p-4 border border-gray-200 hover:border-gray-900 transition-colors group">
                <div className="font-semibold mb-1 group-hover:text-gray-600">Our Services</div>
                <div className="text-sm text-gray-600">Smart home automation services</div>
              </Link>
              <Link href="/solutions" className="p-4 border border-gray-200 hover:border-gray-900 transition-colors group">
                <div className="font-semibold mb-1 group-hover:text-gray-600">Solutions</div>
                <div className="text-sm text-gray-600">Integrated smart living solutions</div>
              </Link>
              <Link href="/case-studies" className="p-4 border border-gray-200 hover:border-gray-900 transition-colors group">
                <div className="font-semibold mb-1 group-hover:text-gray-600">Case Studies</div>
                <div className="text-sm text-gray-600">Real project examples</div>
              </Link>
              <Link href="/why-lexa" className="p-4 border border-gray-200 hover:border-gray-900 transition-colors group">
                <div className="font-semibold mb-1 group-hover:text-gray-600">Why Choose LEXA</div>
                <div className="text-sm text-gray-600">See what makes us different</div>
              </Link>
              <Link href="/glossary" className="p-4 border border-gray-200 hover:border-gray-900 transition-colors group">
                <div className="font-semibold mb-1 group-hover:text-gray-600">Glossary</div>
                <div className="text-sm text-gray-600">Smart home terminology</div>
              </Link>
              <Link href="/contact" className="p-4 border border-gray-200 hover:border-gray-900 transition-colors group">
                <div className="font-semibold mb-1 group-hover:text-gray-600">Contact Us</div>
