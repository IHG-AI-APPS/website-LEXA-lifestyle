...
// Project Types with Sub-categories
const PROJECT_TYPES = [
  {
    id: 'residential',
    label: 'Residential',
...
// Solutions Matrix by Project Type - All prices reduced by 50% for accessibility
const SOLUTIONS_MATRIX = {
  residential: [
    { id: 'security-access', label: 'Security & Access Control', basePrice: 50000, levels: [
      { id: 'basic', label: 'Basic (Smart Locks + Cameras)', price: 25000 },
      { id: 'standard', label: 'Standard (AI Detection + Access Control)', price: 50000 },
      { id: 'premium', label: 'Premium (Biometric + Full Integration)', price: 100000 }
    ]},
    { id: 'lighting', label: 'Lighting Automation', basePrice: 40000, levels: [
      { id: 'basic', label: 'Basic (Wireless Smart Lights)', price: 20000 },
      { id: 'standard', label: 'Standard (Wired with Scenes)', price: 40000 },
      { id: 'premium', label: 'Premium (Lutron HomeWorks)', price: 75000 }
    ]},
    { id: 'climate', label: 'Climate Control (HVAC)', basePrice: 35000, levels: [
      { id: 'basic', label: 'Basic (Smart Thermostats)', price: 18000 },
      { id: 'standard', label: 'Standard (Zone Control)', price: 35000 },
      { id: 'premium', label: 'Premium (Full HVAC Integration)', price: 60000 }
    ]},
    { id: 'entertainment', label: 'Entertainment Systems', basePrice: 75000, levels: [
      { id: 'basic', label: 'Basic (Multi-Room Audio)', price: 30000 },
      { id: 'standard', label: 'Standard (Home Cinema 7.1)', price: 75000 },
      { id: 'premium', label: 'Premium (Dolby Atmos 9.2.4)', price: 140000 }
    ]},
    { id: 'energy', label: 'Energy Management', basePrice: 25000, levels: [
      { id: 'basic', label: 'Basic (Monitoring)', price: 12000 },
      { id: 'standard', label: 'Standard (Solar Integration)', price: 25000 },
      { id: 'premium', label: 'Premium (Full Energy + EV)', price: 50000 }
    ]},
    { id: 'shades', label: 'Motorized Shades', basePrice: 25000, levels: [
      { id: 'basic', label: 'Basic (5-8 Windows)', price: 15000 },
      { id: 'standard', label: 'Standard (10-15 Windows)', price: 25000 },
      { id: 'premium', label: 'Premium (15+ Windows)', price: 45000 }
    ]},
    { id: 'wellness', label: 'Wellness Systems', basePrice: 20000, levels: [
      { id: 'basic', label: 'Basic (Air Quality Monitoring)', price: 10000 },
      { id: 'standard', label: 'Standard (Air + Water Quality)', price: 20000 },
      { id: 'premium', label: 'Premium (Full Wellness Suite)', price: 40000 }
    ]},
    { id: 'integration', label: 'System Integration Platform', basePrice: 40000, levels: [
      { id: 'control4', label: 'Control4 Standard', price: 25000 },
      { id: 'control4-pro', label: 'Control4 Pro', price: 40000 },
      { id: 'crestron', label: 'Crestron', price: 75000 }
    ]}
  ],
  'commercial-office': [
    { id: 'hvac', label: 'HVAC Systems', basePrice: 75000, levels: [
      { id: 'basic', label: 'Basic (Zone Control)', price: 40000 },
      { id: 'standard', label: 'Standard (Smart HVAC + CO2)', price: 75000 },
      { id: 'premium', label: 'Premium (Predictive + Analytics)', price: 125000 }
    ]},
    { id: 'lighting', label: 'Lighting Control', basePrice: 50000, levels: [
      { id: 'basic', label: 'Basic (Occupancy Sensors)', price: 25000 },
      { id: 'standard', label: 'Standard (Daylight Harvesting)', price: 50000 },
      { id: 'premium', label: 'Premium (Full Automation)', price: 90000 }
    ]},
    { id: 'security-access', label: 'Security & Access Control', basePrice: 100000, levels: [
      { id: 'basic', label: 'Basic (Card Access)', price: 50000 },
      { id: 'standard', label: 'Standard (Badge + Visitor Mgmt)', price: 100000 },
      { id: 'enterprise', label: 'Enterprise (Full Integration)', price: 175000 }
    ]},
    { id: 'fire-safety', label: 'Fire Safety & Life Safety', basePrice: 60000, levels: [
      { id: 'standard', label: 'Standard (Code Compliant)', price: 60000 },
      { id: 'premium', label: 'Premium (Integrated Protocols)', price: 100000 }
    ]},
    { id: 'energy-analytics', label: 'Energy Analytics & Reporting', basePrice: 40000, levels: [
      { id: 'basic', label: 'Basic (Monitoring)', price: 20000 },
      { id: 'standard', label: 'Standard (LEED Tracking)', price: 40000 },
      { id: 'enterprise', label: 'Enterprise (Full Analytics)', price: 75000 }
    ]},
    { id: 'network', label: 'Network Infrastructure', basePrice: 50000, levels: [
      { id: 'standard', label: 'Standard (Enterprise WiFi 6E)', price: 50000 },
      { id: 'premium', label: 'Premium (Full IoT + Cloud)', price: 90000 }
    ]},
    { id: 'meeting-rooms', label: 'Meeting Room Management', basePrice: 30000, levels: [
      { id: 'basic', label: 'Basic (Booking System)', price: 15000 },
      { id: 'standard', label: 'Standard (AV Control)', price: 30000 },
      { id: 'premium', label: 'Premium (Full Automation)', price: 60000 }
    ]}
  ],
  hospitality: [
    { id: 'guest-room', label: 'Guest Room Automation', basePrice: 60000, levels: [
      { id: 'basic', label: 'Basic (Smart Thermostat + Lights)', price: 30000 },
      { id: 'standard', label: 'Standard (Welcome Scenes)', price: 60000 },
      { id: 'premium', label: 'Premium (Full Personalization)', price: 100000 }
    ]},
    { id: 'energy', label: 'Energy Management', basePrice: 75000, levels: [
      { id: 'standard', label: 'Standard (Occupancy-based)', price: 75000 },
      { id: 'premium', label: 'Premium (Smart Grid + 30% Savings)', price: 140000 }
    ]},
    { id: 'security-access', label: 'Security & Access', basePrice: 90000, levels: [
      { id: 'basic', label: 'Basic (Card Keys)', price: 45000 },
      { id: 'standard', label: 'Standard (Mobile Keys)', price: 90000 },
      { id: 'premium', label: 'Premium (Biometric + Master)', price: 160000 }
    ]},
    { id: 'entertainment', label: 'In-Room Entertainment', basePrice: 50000, levels: [
      { id: 'basic', label: 'Basic (Smart TVs)', price: 25000 },
      { id: 'standard', label: 'Standard (Casting + Streaming)', price: 50000 },
      { id: 'premium', label: 'Premium (Full Control)', price: 90000 }
    ]},
    { id: 'operations', label: 'Operational Efficiency', basePrice: 50000, levels: [
      { id: 'standard', label: 'Standard (Housekeeping Status)', price: 50000 },
      { id: 'premium', label: 'Premium (Predictive + Maintenance)', price: 90000 }
    ]},
    { id: 'common-areas', label: 'Common Area Management', basePrice: 60000, levels: [
      { id: 'standard', label: 'Standard (Lobby + Restaurant)', price: 60000 },
      { id: 'premium', label: 'Premium (Full Property)', price: 110000 }
    ]}
  ],
  healthcare: [
    { id: 'hvac-air', label: 'HVAC & Air Quality', basePrice: 125000, levels: [
      { id: 'standard', label: 'Standard (Infection Control)', price: 125000 },
      { id: 'premium', label: 'Premium (Negative Pressure + HEPA)', price: 225000 }
    ]},
    { id: 'lighting', label: 'Healthcare Lighting', basePrice: 60000, levels: [
      { id: 'standard', label: 'Standard (Circadian + Patient Care)', price: 60000 },
      { id: 'premium', label: 'Premium (Surgical + Full Control)', price: 110000 }
    ]},
    { id: 'security-access', label: 'Security & Access Control', basePrice: 140000, levels: [
      { id: 'standard', label: 'Standard (Staff Badge + RTLS)', price: 140000 },
      { id: 'enterprise', label: 'Enterprise (Patient Tracking)', price: 240000 }
    ]},
    { id: 'nurse-call', label: 'Nurse Call Integration', basePrice: 75000, levels: [
      { id: 'standard', label: 'Standard (Patient Alerts)', price: 75000 },
      { id: 'premium', label: 'Premium (Workflow Integration)', price: 140000 }
    ]},
    { id: 'medical-equipment', label: 'Medical Equipment Monitoring', basePrice: 90000, levels: [
      { id: 'standard', label: 'Standard (Asset Tracking)', price: 90000 },
      { id: 'premium', label: 'Premium (Full Monitoring)', price: 160000 }
    ]}
  ],
  education: [
    { id: 'campus-security', label: 'Campus Security', basePrice: 100000, levels: [
      { id: 'standard', label: 'Standard (Access + Surveillance)', price: 100000 },
      { id: 'premium', label: 'Premium (Lockdown Protocols)', price: 175000 }
    ]},
    { id: 'hvac-energy', label: 'HVAC & Energy', basePrice: 90000, levels: [
      { id: 'standard', label: 'Standard (Classroom Control)', price: 90000 },
      { id: 'premium', label: 'Premium (Green Building)', price: 160000 }
    ]},
    { id: 'lighting', label: 'Lighting Control', basePrice: 50000, levels: [
      { id: 'standard', label: 'Standard (Classroom Automation)', price: 50000 },
      { id: 'premium', label: 'Premium (Campus-wide)', price: 90000 }
    ]},
    { id: 'fire-safety', label: 'Fire Safety', basePrice: 60000, levels: [
      { id: 'standard', label: 'Standard (Code Compliant)', price: 60000 }
    ]},
    { id: 'classroom-tech', label: 'Classroom Technology', basePrice: 50000, levels: [
      { id: 'basic', label: 'Basic (AV Systems)', price: 25000 },
      { id: 'standard', label: 'Standard (Smart Boards)', price: 50000 },
      { id: 'premium', label: 'Premium (Full Integration)', price: 90000 }
    ]}
  ],
  retail: [
    { id: 'hvac-refrigeration', label: 'HVAC & Refrigeration', basePrice: 100000, levels: [
      { id: 'standard', label: 'Standard (Zone + Cooler Monitoring)', price: 100000 },
      { id: 'premium', label: 'Premium (Predictive + 30% Savings)', price: 175000 }
    ]},
    { id: 'lighting', label: 'Retail Lighting', basePrice: 60000, levels: [
      { id: 'standard', label: 'Standard (Display Lighting)', price: 60000 },
      { id: 'premium', label: 'Premium (Full Automation)', price: 110000 }
    ]},
    { id: 'security', label: 'Security Systems', basePrice: 75000, levels: [
      { id: 'standard', label: 'Standard (Surveillance + Loss Prevention)', price: 75000 },
      { id: 'premium', label: 'Premium (Integrated Security)', price: 140000 }
    ]},
    { id: 'customer-experience', label: 'Customer Experience', basePrice: 40000, levels: [
      { id: 'standard', label: 'Standard (Digital Signage + Music)', price: 40000 },
      { id: 'premium', label: 'Premium (Full Ambiance Control)', price: 75000 }
    ]},
    { id: 'energy', label: 'Energy Management', basePrice: 50000, levels: [
      { id: 'standard', label: 'Standard (Monitoring)', price: 50000 },
      { id: 'premium', label: 'Premium (Demand Response)', price: 90000 }
    ]}
  ],
  'mixed-use': [
    { id: 'integrated-systems', label: 'Integrated Systems', basePrice: 150000, levels: [
      { id: 'standard', label: 'Standard (Unified Platform)', price: 150000 },
      { id: 'premium', label: 'Premium (Full Integration)', price: 275000 }
    ]},
    { id: 'security-access', label: 'Security & Access', basePrice: 125000, levels: [
      { id: 'standard', label: 'Standard (Multi-Zone)', price: 125000 },
      { id: 'enterprise', label: 'Enterprise (Complex-wide)', price: 225000 }
    ]},
    { id: 'energy', label: 'Energy Management', basePrice: 90000, levels: [
      { id: 'standard', label: 'Standard (Multi-Use Monitoring)', price: 90000 },
      { id: 'premium', label: 'Premium (Full Analytics)', price: 160000 }
    ]},
    { id: 'hvac-climate', label: 'HVAC & Climate', basePrice: 110000, levels: [
      { id: 'standard', label: 'Standard (Zone Control)', price: 110000 },
      { id: 'premium', label: 'Premium (Integrated Control)', price: 200000 }
    ]}
  ]
}

// Additional Features - All prices reduced by 50%
const ADDITIONAL_FEATURES = [
  { id: 'voice-control', label: 'Voice Control Integration (Alexa/Google)', price: 8000 },
  { id: 'outdoor-entertainment', label: 'Outdoor Entertainment Area', price: 22000 },
  { id: 'pool-spa', label: 'Pool & Spa Automation', price: 18000 },
  { id: 'landscape-lighting', label: 'Landscape Lighting', price: 12000 },
  { id: 'solar', label: 'Solar/Renewable Integration', price: 25000 },
  { id: 'backup-power', label: 'Backup Generator Integration', price: 30000 },
  { id: 'ev-charging', label: 'EV Charging Infrastructure', price: 15000 },
  { id: 'future-wiring', label: 'Future Expansion Pre-wiring', price: 10000 }
]

// Brands
const CONTROL_PLATFORMS = ['Control4', 'Crestron', 'KNX', 'Savant', 'No Preference']
const SECURITY_BRANDS = ['Hikvision', 'Axis', 'Hanwha', 'Bosch', 'No Preference']
const LIGHTING_BRANDS = ['Lutron', 'KNX', 'DALI', 'Wireless (Zigbee/Z-Wave)', 'No Preference']

// UAE Emirates & Cities
const LOCATIONS = {
  'Dubai': ['Downtown Dubai', 'Dubai Marina', 'Palm Jumeirah', 'Emirates Hills', 'Arabian Ranches', 'Business Bay', 'JBR', 'Other'],
  'Abu Dhabi': ['Saadiyat Island', 'Yas Island', 'Al Reem Island', 'Corniche', 'Al Raha Beach', 'Other'],
  'Sharjah': ['Al Majaz', 'Al Khan', 'Muwaileh', 'Other'],
  'Ajman': ['Ajman Downtown', 'Al Nuaimia', 'Other'],
  'RAK': ['Al Hamra', 'Mina Al Arab', 'Other'],
  'Fujairah': ['City Center', 'Dibba', 'Other'],
  'UAQ': ['City Center', 'Other']
}
            ...
            <AnimatePresence mode="wait">
                      ...
                      >
                        <div className="flex justify-between items-start">
                          <div>
                            ...
                            <div className="text-sm text-gray-600 mb-2">{PACKAGE_BUNDLES['smart-office'].description}</div>
              ...
              {step === 5 && (
                ...
                >
                  ...
                  <p className="text-gray-600 mb-8">Optional: Select your preferred brands or skip this step</p>
              ...
              {step === 9 && (
                ...
                >
                  ...
                  <div className="bg-gray-50 border-2 border-gray-200 rounded-lg p-6 space-y-4">
                    <div>
                      <div className="text-sm font-semibold text-gray-600 uppercase">Project Type</div>
                      <div className="text-lg">{currentProjectType?.label} - {subCategory}</div>
                    </div>

                    <div>
                      <div className="text-sm font-semibold text-gray-600 uppercase">Area</div>
                      <div className="text-lg">{squareFootage} sq ft • {numRooms} rooms</div>
                    </div>

                    <div>
                      <div className="text-sm font-semibold text-gray-600 uppercase">Selected Solutions</div>
                      <div className="text-lg">{Object.keys(selectedSolutions).length} systems selected</div>
                    </div>

                    <div>
                      <div className="text-sm font-semibold text-gray-600 uppercase">Timeline</div>
                      <div className="text-lg">{timeline}</div>
                    </div>

                    <div>
                      <div className="text-sm font-semibold text-gray-600 uppercase">Location</div>
