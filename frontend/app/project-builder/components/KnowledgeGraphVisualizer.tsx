...
export default function KnowledgeGraphVisualizer({
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
          ...
          <Panel position="top-right" className="bg-white border border-gray-200 rounded-lg p-4 shadow-lg">
            ...
            <div className="space-y-2 text-xs">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700">Required Dependency</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-6 h-0.5 bg-blue-600"></div>
                <span className="text-gray-700">Dependency Link</span>
              </div>
            </div>
      ...
      {/* Warnings Section */}
      {warningsCount > 0 && (
        <div className="border-t border-gray-200 bg-orange-50 p-6">
