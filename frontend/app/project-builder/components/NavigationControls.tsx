    ...
    <>
      ...
      <div className="hidden lg:block fixed bottom-8 left-0 right-0 z-30">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            ...
            className="bg-white/95 backdrop-blur-xl border border-gray-200 rounded-full px-6 py-4 elevation-6 flex items-center justify-between"
          >
            {/* Back Button */}
            <Button
              variant="outline"
      ...
      <div className="lg:hidden fixed bottom-20 left-0 right-0 z-30 px-4 pb-4">
        <motion.div
          ...
          animate={{ y: 0, opacity: 1 }}
          transition={{ delay: 0.3, duration: 0.5, ease: [0.16, 1, 0.3, 1] }}
          className="bg-white/95 backdrop-blur-xl border border-gray-200 rounded-2xl p-4 elevation-6"
        >
