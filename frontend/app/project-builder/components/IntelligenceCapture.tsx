      ...
      >
          ...
          <div className="space-y-3">
            {[
              ...
              <label key={constraint.key} className="flex items-start gap-3 p-4 border border-gray-200 hover:border-blue-600 cursor-pointer transition-colors">
                ...
                />
                <div>
                  <div className="text-sm font-medium text-gray-900">{constraint.label}</div>
                  <div className="text-xs text-gray-600">{constraint.desc}</div>
                </div>
              </label>
            ))}
          </div>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-purple-50 border border-blue-200 p-8 mb-12">
          ...
          >
            ...
            <div className="text-sm text-gray-700">Click to upload or drag files here</div>
