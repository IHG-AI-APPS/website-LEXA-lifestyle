  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      >
        ...
        {/* Budget Constraint */}
        <div className="bg-white dark:bg-[#171717] border border-gray-200 dark:border-zinc-800 p-8 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="text-xs uppercase tracking-widest text-gray-600 dark:text-zinc-500 mb-2 block">Maximum Budget (Optional)</label>
              <Input
                type="text"
                value={constraints.budget_max}
                onChange={(e) => setConstraints({ ...constraints, budget_max: e.target.value })}
                placeholder="e.g., AED 500,000"
                className="border-gray-200 dark:border-zinc-800 focus:border-[#C9A962]"
              />
            </div>
            <div>
              <label className="text-xs uppercase tracking-widest text-gray-600 dark:text-zinc-500 mb-2 block">Timeline Constraint</label>
              <Input
                type="text"
        ...
        <div className="bg-white dark:bg-[#171717] border border-gray-200 dark:border-zinc-800 p-8 mb-6">
          ...
          <div className="space-y-3">
            {[
              ...
              <label key={constraint.key} className="flex items-start gap-3 p-4 border border-gray-200 dark:border-zinc-800 hover:border-[#C9A962] cursor-pointer transition-colors">
                <input
                  type="checkbox"
                  ...
                  className="mt-1 w-4 h-4 text-[#C9A962] border-gray-300 dark:border-zinc-700 rounded focus:ring-[#C9A962]"
                />
                <div>
                  <div className="text-sm font-medium text-gray-900 dark:text-white">{constraint.label}</div>
                  <div className="text-xs text-gray-600 dark:text-zinc-500">{constraint.desc}</div>
                </div>
              </label>
            ))}
          </div>
        ...
        <div className="bg-white dark:bg-[#171717] border border-gray-200 dark:border-zinc-800 p-8 mb-6">
          ...
          <textarea
            ...
            rows={4}
            className="w-full border border-gray-200 dark:border-zinc-800 focus:border-[#C9A962] outline-none text-gray-900 dark:text-white placeholder-gray-400 p-4 text-sm"
          />
        </div>
        ...
        <div className="bg-gradient-to-br from-[#C9A962]/5 to-[#A68B4B]/5 border border-[#C9A962]/20 p-8 mb-12">
          ...
          >
            ...
            <div className="text-sm text-gray-700 dark:text-zinc-400">Click to upload or drag files here</div>
          ...
          {uploadedFiles.length > 0 && (
            <div className="mt-4 space-y-2">
              {uploadedFiles.map((file, index) => (
                <div key={index} className="flex items-center justify-between p-3 bg-white dark:bg-[#171717] border border-gray-200 dark:border-zinc-800">
        ...
        <div className="bg-[#C9A962]/5 border border-[#C9A962]/20 p-4 mb-8 flex items-start gap-3">
          ...
          <div className="text-xs text-gray-700 dark:text-zinc-400">
