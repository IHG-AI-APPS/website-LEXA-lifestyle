      ...
      <div className="space-y-8">
                ...
                <button
                  ...
                  className={`w-12 h-12 rounded-lg border-2 font-bold transition-all ${
                    bedrooms === (typeof num === 'number' ? num : 7)
                      ...
                      : 'border-gray-200 dark:border-zinc-800 bg-white text-gray-600 dark:text-zinc-500 hover:border-gray-300'
                  }`}
                >
                  {num}
                </button>
              ...
              <button
                ...
                className={`p-3 rounded-lg border-2 text-sm font-medium transition-all ${
                  location === loc
                    ...
                    : 'border-gray-200 dark:border-zinc-800 bg-white text-gray-700 dark:text-zinc-400 hover:border-gray-300'
                }`}
              >
                {loc}
              </button>
        ...
        >
          ...
          <textarea
            ...
            className="w-full p-4 rounded-xl border-2 border-gray-200 dark:border-zinc-800 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all resize-none"
            rows={3}
          />
        </motion.section>
      </div>
