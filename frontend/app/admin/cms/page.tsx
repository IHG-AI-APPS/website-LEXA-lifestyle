...
const CMS_SECTIONS: CMSSection[] = [
  ...
  { key: 'page_company', label: 'Company', icon: Building, category: 'pages', description: 'Company values, stats, overview' },
  { key: 'page_contact', label: 'Contact', icon: Phone, category: 'pages', description: 'Contact info, office details, hours' },
  { key: 'page_faq', label: 'FAQ', icon: HelpCircle, category: 'pages', description: 'FAQ hero text and intro' },
  { key: 'page_process', label: 'Our Process', icon: Settings, category: 'pages', description: 'Process phases, durations, activities' },
  { key: 'page_experience_centre', label: 'Experience Centre', icon: Eye, category: 'pages', description: 'Showroom features, zones, booking info' },
  { key: 'page_architects', label: 'For Architects', icon: PenTool, category: 'pages', description: 'Architect-focused content and benefits' },
  { key: 'page_contractors', label: 'For Contractors', icon: Wrench, category: 'pages', description: 'Contractor-focused content and services' },
  { key: 'page_developers', label: 'For Developers', icon: Building, category: 'pages', description: 'Developer-focused packages and benefits' },
  { key: 'page_partner_with_us', label: 'Partner With Us', icon: Users, category: 'pages', description: 'Partnership opportunities and benefits' },
  { key: 'page_work_with_us', label: 'Work With Us', icon: Briefcase, category: 'pages', description: 'Career page hero and intro' },
  { key: 'page_certification_standard', label: 'Certifications', icon: Award, category: 'pages', description: 'Industry certifications and quality standards' },
  { key: 'page_hidden_costs', label: 'Hidden Costs', icon: AlertTriangle, category: 'pages', description: 'Hidden cost categories and transparency info' },
  { key: 'page_investment_pricing', label: 'Investment & Pricing', icon: DollarSign, category: 'pages', description: 'Pricing tiers, packages, investment guide' },
  { key: 'page_lexa_evolves', label: 'LEXA Evolves', icon: TrendingUp, category: 'pages', description: 'Company journey and evolution story' },
  { key: 'page_platform_agnostic', label: 'Platform Agnostic', icon: Layers, category: 'pages', description: 'Technology philosophy and approach' },
  { key: 'page_vendor_supplier', label: 'Vendor & Supplier', icon: Package, category: 'pages', description: 'Supplier portal content' },
  { key: 'page_amc_packages', label: 'AMC Packages', icon: Shield, category: 'pages', description: 'Maintenance contract packages and pricing' },
  { key: 'page_consultation', label: 'Consultation', icon: Calendar, category: 'pages', description: 'Consultation booking page content' },
  { key: 'page_testimonials_listing', label: 'Testimonials', icon: Star, category: 'pages', description: 'Testimonials listing page hero' },
  { key: 'page_persona_homeowner', label: 'Persona: Homeowner', icon: Home, category: 'pages', description: 'Homeowner persona page content' },
  { key: 'page_persona_architect', label: 'Persona: Architect', icon: PenTool, category: 'pages', description: 'Architect persona page content' },
  { key: 'page_persona_developer', label: 'Persona: Developer', icon: Building, category: 'pages', description: 'Developer persona page content' },
  { key: 'page_persona_commercial', label: 'Persona: Commercial', icon: Building, category: 'pages', description: 'Commercial persona page content' },
  { key: 'page_partners_architects', label: 'Partners: Architects', icon: PenTool, category: 'pages', description: 'Architect partner program content' },
  { key: 'page_partners_developers', label: 'Partners: Developers', icon: Building, category: 'pages', description: 'Developer partner program content' },
  { key: 'page_careers', label: 'Careers', icon: Briefcase, category: 'pages', description: 'Job listings, benefits, how to apply' },
  { key: 'page_media', label: 'Media Gallery', icon: Film, category: 'pages', description: 'Video library hero text and sections' },
  { key: 'page_support', label: '24/7 Support', icon: Settings2, category: 'pages', description: 'Emergency support info, scenarios, AMC benefits' },
  { key: 'page_warranty', label: 'Warranty', icon: Award, category: 'pages', description: 'Warranty coverage, exclusions, claim process' },
  { key: 'page_developer_toolkit', label: 'Developer Toolkit', icon: Layers, category: 'pages', description: 'Partnership resources, toolkit, access requirements' },
  { key: 'page_privacy_policy', label: 'Privacy Policy', icon: FileText, category: 'pages', description: 'Privacy policy sections and content' },
  { key: 'page_terms', label: 'Terms & Conditions', icon: FileText, category: 'pages', description: 'Terms and conditions sections' },
  { key: 'page_terms_of_service', label: 'Terms of Service', icon: FileText, category: 'pages', description: 'Terms of service sections' },
  { key: 'page_privacy', label: 'Privacy (Short)', icon: FileText, category: 'pages', description: 'Short privacy policy sections' },
  // Services
