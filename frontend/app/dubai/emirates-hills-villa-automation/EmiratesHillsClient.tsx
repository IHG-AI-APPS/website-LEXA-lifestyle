...
export default function EmiratesHillsClient() {
  const cms = useCms('page_geo_dubai_emirates_hills_villa_automation', null)
    ...
    <div className={`min-h-screen transition-colors duration-300 ${isDark ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'}`}>
      <section className="relative min-h-[80vh] flex items-center">
        <div className="absolute inset-0 z-0">
          <SafeImage src="https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=1920" alt="Emirates Hills Villa" fill className="object-cover" priority />
