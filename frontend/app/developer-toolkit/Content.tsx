...
const fallback = {
  ...
  toolkit_resources: [
    ...
    { title: 'Sample Floorplan Automation Layouts', description: 'Standard automation layouts for 1BR, 2BR, 3BR, and penthouse units with device placement', formats: ['DWG', 'PDF'], color: 'from-[#C9A962] to-[#C9A962]/50' },
