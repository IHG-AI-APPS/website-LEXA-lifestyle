...
export default function MuscatClient() {
  const cms = useCms('page_geo_oman_muscat_home_automation', null)
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-900 dark:text-white dark:text-white">Muscat Communities We Serve</h2>
