    ...
    <div className="min-h-screen bg-white dark:bg-[#050505] pt-20" data-testid="blog-page">
      ...
      <section className="relative overflow-hidden bg-[#0A0A0A] dark:bg-[#050505] text-white py-16 lg:py-24">
        ...
        <div className="absolute inset-0">
          <div style={{backgroundImage: "url(https://static.prod-images.emergentagent.com/jobs/9a576253-3f34-4de3-9ad4-57e7617524d7/images/11fcb774367dc2ab0241d846c3ead525ef76a224666ee445c8e0db95e63e9746.png)"}} className="absolute inset-0 bg-cover bg-center opacity-80" />
                    ...
                    <div className="group h-full border border-gray-200 dark:border-zinc-800 hover:border-charcoal transition-all bg-white dark:bg-[#171717] rounded-lg overflow-hidden">
                      ...
                      <div className="relative h-64 overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200">
                        ...
                        <button
                          ...
                          className="absolute bottom-4 left-1/2 -translate-x-1/2 px-5 py-2 bg-white/90 dark:bg-black/70 backdrop-blur-sm text-gray-900 dark:text-white text-xs font-medium tracking-wider uppercase rounded-full sm:opacity-0 sm:group-hover:opacity-100 sm:translate-y-2 sm:group-hover:translate-y-0 transition-all duration-300 hover:bg-[#C9A962] hover:text-white z-10"
