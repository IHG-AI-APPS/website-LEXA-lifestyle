                  ...
                  <div className="relative h-full overflow-hidden rounded-2xl bg-white dark:bg-[#171717] elevation-2 hover:elevation-4 transition-all duration-300 border border-gray-100 dark:border-zinc-800">
                    ...
                    <div className="relative h-64 overflow-hidden">
                      ...
                      <div className="absolute top-4 right-4">
                        <div className="bg-black/80 dark:bg-[#C9A962] backdrop-blur-sm p-3 rounded-full">
                      ...
                      {service.category && (
                        <div className="absolute top-4 left-4">
                          <span className="bg-black/80 dark:bg-[#C9A962] backdrop-blur-sm px-3 py-1.5 rounded-full text-xs font-semibold text-white dark:text-black">
                            {service.category}
                          </span>
                        </div>
                      )}
