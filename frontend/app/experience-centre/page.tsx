...
const facilities = [
  { id: 1, title: 'Smart Home Showcase', description: 'Experience the latest in home automation, lighting control, and intelligent living systems.', image: 'https://files.ihgbrands.com/lexa/migrated/0641eef46c96198d.webp', features: ['Voice Control', 'Automated Lighting', 'Climate Management'] },
  { id: 2, title: 'Home Cinema Experience', description: 'State-of-the-art home theater with premium acoustics and immersive 4K projection.', image: 'https://files.ihgbrands.com/lexa/migrated/add489a013a13706.webp', features: ['Dolby Atmos', '4K Projection', 'Acoustic Treatment'] },
  { id: 3, title: 'Premium Brand Gallery', description: 'Explore luxury brands and cutting-edge technology solutions from world-leading manufacturers.', image: 'https://files.ihgbrands.com/lexa/migrated/a3b546f210cfd4cb.webp', features: ['32+ Brands', 'Live Demos', 'Expert Consultation'] },
  { id: 4, title: 'Audio & Multi-Room Systems', description: 'High-fidelity audio solutions with multi-room capabilities and wireless streaming.', image: 'https://files.ihgbrands.com/lexa/migrated/8e8a1e890ec79775.webp', features: ['Hi-Fi Systems', 'Multi-Room Audio', 'Streaming Integration'] },
  { id: 5, title: 'Lighting Design Studio', description: 'Sophisticated lighting control systems showcasing ambiance and energy efficiency.', image: 'https://files.ihgbrands.com/lexa/migrated/c46836f176dba77d.webp', features: ['Scene Control', 'Circadian Lighting', 'Energy Monitoring'] },
  { id: 6, title: 'Security & Surveillance', description: 'Advanced security systems with facial recognition, access control, and monitoring.', image: 'https://files.ihgbrands.com/lexa/migrated/f5e4fceb477845f7.webp', features: ['Facial Recognition', 'Access Control', '24/7 Monitoring'] },
]
    ...
    <div className="min-h-screen bg-white dark:bg-[#050505] pt-20" data-testid="experience-centre-page">
      ...
      <section className="relative overflow-hidden bg-[#0A0A0A] dark:bg-[#050505] text-white pt-12 pb-20">
        ...
        <div className="absolute inset-0">
          <SafeImage src="https://files.ihgbrands.com/lexa/migrated/625dd79059eb6676.webp" alt="LEXA Experience Centre" fill className="object-cover opacity-40" priority sizes="100vw" />
