    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-900 dark:text-white">NEOM Zones We Serve</h2>
          <div className="grid md:grid-cols-2 gap-6">
            {zones.map((z, i) => (
              <div key={i} className="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-lg border-l-4 border-purple-500">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white">{z.name}</h3>
