    ...
    <div className="min-h-screen bg-white dark:bg-[#050505] pt-20" data-testid="process-page">
      ...
      <section className="relative overflow-hidden bg-[#0A0A0A] dark:bg-[#050505] text-white py-16 lg:py-24">
        ...
        <div className="absolute inset-0">
          <div style={{backgroundImage: "url(https://files.ihgbrands.com/lexa/migrated/ccce49007f145042.webp)"}} className="absolute inset-0 bg-cover bg-center opacity-80" />
        ...
        <div className="container mx-auto px-5 sm:px-8 lg:px-16 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-3xl">
            <span className="hero-animate-badge inline-block px-2.5 py-1 sm:px-3 rounded-full bg-[#C9A962]/15 border border-[#C9A962]/30 text-[#C9A962] text-xs uppercase tracking-widest mb-5">{cms?.hero_badge || 'Our Process'}</span>
