      ...
      <section className="relative overflow-hidden bg-[#0A0A0A] dark:bg-[#050505] text-white py-20 lg:py-28">
        <div className="container mx-auto px-8 lg:px-16 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <span className="hero-animate-badge inline-block px-3 py-1 rounded-full bg-[#C9A962]/15 border border-[#C9A962]/30 text-[#C9A962] text-xs uppercase tracking-widest mb-5">Vendor & Supplier Portal</span>
            <h1 className="hero-animate-title text-4xl sm:text-5xl lg:text-6xl font-bold uppercase mb-5 tracking-tight" data-testid="vendor-supplier-title">
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-green-50 rounded-lg border border-green-200">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900 dark:text-white dark:text-white">High Priority</div>
                    <div className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">AI-powered automation systems, Voice control platforms</div>
                  </div>
                </div>
                <div className="flex items-center gap-4 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                  <div className="w-3 h-3 bg-yellow-500 rounded-full" />
                  <div>
                    <div className="font-semibold text-gray-900 dark:text-white dark:text-white">Medium Priority</div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    {productCategories.map((cat) => (
                      ...
                      >
                        ...
                        <div className="font-medium text-gray-900 dark:text-white text-xs">{cat.name}</div>
                      </button>
                    ))}
                  </div>
