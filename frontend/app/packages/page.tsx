...
export default function PackagesPage() {
  ...
  const apartmentTiers = [
    { name: 'Basic', price: '3,000', color: 'bg-[#C9A962]' },
    ...
    <div className="min-h-screen bg-white dark:bg-[#050505] pt-20" data-testid="packages-page">
      ...
      <section className="relative overflow-hidden bg-[#0A0A0A] dark:bg-[#050505] text-white py-16 lg:py-24">
        ...
        <div className="absolute inset-0">
          <div style={{backgroundImage: "url(https://static.prod-images.emergentagent.com/jobs/9a576253-3f34-4de3-9ad4-57e7617524d7/images/3d2d612a5293efaed90334a256cea50236882124f2d9aec7ad83ffe93a6f0e8b.png)"}} className="absolute inset-0 bg-cover bg-center opacity-80" />
          <div className="absolute inset-0 bg-gradient-to-t from-[#0A0A0A]/80 via-[#0A0A0A]/40 to-transparent" />
        </div>
        <div className="container mx-auto px-5 sm:px-8 lg:px-16 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <span className="hero-animate-badge inline-block px-2.5 py-1 sm:px-3 rounded-full bg-[#C9A962]/15 border border-[#C9A962]/30 text-[#C9A962] text-xs uppercase tracking-widest mb-5">Smart Home Solutions</span>
            <h1 className="hero-animate-title text-3xl sm:text-4xl lg:text-5xl font-bold uppercase mb-5 tracking-tight" data-testid="packages-title">
              All Packages
            </h1>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-12">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href="/packages/smart-apartment-packages" className="text-sm text-[#C9A962] hover:underline flex items-center gap-1">
