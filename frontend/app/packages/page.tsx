    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 pt-20" data-testid="packages-page">
      ...
      <section className="relative overflow-hidden bg-[#0A0A0A] dark:bg-[#050505] text-white py-20 lg:py-28">
        ...
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=1200&q=50" alt="" className="w-full h-full object-cover opacity-20" loading="eager" />
        ...
        <div className="container mx-auto px-8 lg:px-16 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold uppercase mb-5 tracking-tight" data-testid="packages-title">
              All Packages
            </h1>
