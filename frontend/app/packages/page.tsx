    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 pt-20" data-testid="packages-page">
      ...
      <section className="relative overflow-hidden bg-[#0A0A0A] dark:bg-[#050505] text-white py-20 lg:py-28">
        ...
        <div className="absolute inset-0">
          <div style={{backgroundImage: "url(https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=1200&q=50)"}} className="absolute inset-0 bg-cover bg-center opacity-50" />
