...
function ValueProposition() {
  return (
    <section className="bg-white dark:bg-[#050505] py-24 md:py-32 lg:py-40 overflow-hidden" data-testid="value-proposition">
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 lg:px-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <motion.h2 
              variants={fadeInUp}
              className="text-4xl md:text-5xl lg:text-6xl font-light text-gray-900 dark:text-white leading-[1.1] tracking-tight mb-8"
            >
            ...
            <motion.p 
              variants={fadeInUp}
              className="text-base md:text-lg text-gray-600 dark:text-white/60 leading-relaxed max-w-xl mb-10"
            >
            ...
            <motion.div variants={fadeInUp}>
              <Link 
                href="/solutions"
                className="group inline-flex items-center gap-3 text-gray-900 dark:text-white text-sm uppercase tracking-[0.2em] hover:text-[#C9A962] transition-colors"
          ...
          >
            {[
              ...
              <motion.div 
                key={stat.label}
                variants={scaleIn}
                className="bg-gray-50 dark:bg-[#111] border border-gray-200 dark:border-white/5 p-6 md:p-8 hover:border-[#C9A962]/40 dark:hover:border-[#C9A962]/20 transition-colors duration-500"
              >
                <motion.div 
                ...
                <div className="text-xs uppercase tracking-[0.2em] text-gray-500 dark:text-white/40">
                  {stat.label}
                </div>
              </motion.div>
            ))}
...
export default function HomePage() {
  ...
  return (
    <div className="bg-white dark:bg-[#050505]" style={{ minHeight: '100vh' }} data-testid="homepage">
