...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://smart-builder-launch.preview.emergentagent.com/guides/how-to-install-smart-home-dubai'
  }
}
            ...
            {guideData.steps.map((step, index) => (
              <div key={index} className="flex gap-6 pb-12 border-b border-gray-200 last:border-0">
                ...
                <div className="flex-1">
                  <h2 className="text-2xl font-bold mb-4 text-gray-900">{step.name}</h2>
