    ...
    <section className="py-32 bg-gray-50">
      <div className="container mx-auto px-4 md:px-8 max-w-7xl">
        ...
        >
          <Link
            href="/brands"
            className="inline-flex items-center gap-2 text-black hover:text-gray-600 dark:text-zinc-500 transition-colors font-medium uppercase tracking-wider text-sm"
          >
            View All 32 Brands
