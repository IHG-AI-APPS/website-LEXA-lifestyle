...
export default function StatsLight() {
  ...
  return (
    <section ref={ref} className="py-24 bg-gray-50 border-y border-gray-200 dark:border-zinc-800">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 md:gap-12">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="text-xs md:text-sm tracking-[0.2em] uppercase text-gray-600 dark:text-zinc-500 font-medium">
                {stat.label}
              </div>
            </motion.div>
          ))}
