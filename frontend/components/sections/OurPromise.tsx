        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {promises.map((promise, index) => (
            <motion.div
              ...
              className="bg-white border border-gray-200 p-8 group hover:border-gray-400 transition-all duration-300"
            >
              <promise.icon className="w-12 h-12 text-gray-600 mb-6 stroke-[1.5] group-hover:text-black transition-colors" />
