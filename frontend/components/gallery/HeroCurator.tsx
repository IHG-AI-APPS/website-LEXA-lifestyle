    ...
    >
      ...
      <div className="relative z-20 w-full grid grid-cols-1 sm:grid-cols-2 flex-shrink-0" data-testid="hero-cta-band">
        <button
          ...
          className="group flex items-center justify-center gap-3 py-4 sm:py-5 bg-gradient-to-r from-[#C9A962] to-[#E8D5A3] text-[#050505] text-xs sm:text-sm font-bold tracking-[0.2em] uppercase transition-all duration-300 hover:from-[#D4B872] hover:to-[#F0E0B5] cursor-pointer"
        >
