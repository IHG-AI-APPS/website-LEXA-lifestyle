      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 sm:bottom-28 right-4 sm:right-6 z-[55] w-[calc(100vw-32px)] sm:w-80 max-w-80 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden"
          >
