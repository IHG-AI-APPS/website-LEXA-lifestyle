      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 sm:bottom-28 right-4 sm:right-6 z-[55] w-[calc(100vw-32px)] sm:w-80 max-w-80 bg-white dark:bg-[#171717] rounded-2xl shadow-2xl border border-gray-200 dark:border-zinc-800 overflow-hidden"
          >
            ...
            <div className="p-4 space-y-2 max-h-96 overflow-y-auto">
              {messages.map((msg, index) => (
                <button
                  ...
                  className="w-full text-left p-4 rounded-xl border-2 border-gray-200 dark:border-zinc-800 hover:border-green-500 hover:bg-green-50 transition-all group"
                >
