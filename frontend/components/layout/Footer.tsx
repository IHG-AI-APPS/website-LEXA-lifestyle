        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <a href={socials.tiktok || 'https://www.tiktok.com/@lexalifestyle'} target="_blank" rel="noopener noreferrer" 
                className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#C9A962] hover:border-[#C9A962] transition-all text-gray-300 hover:text-white" 
              ...
              <a href={socials.twitter || 'https://x.com/lexalifestyle'} target="_blank" rel="noopener noreferrer" 
                className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#C9A962] hover:border-[#C9A962] transition-all text-gray-300 hover:text-white" 
