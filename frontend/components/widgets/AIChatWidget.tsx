      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-4 right-4 z-50 w-[380px] max-w-[calc(100vw-32px)] h-[600px] max-h-[calc(100vh-100px)] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-gray-200"
          >
            {/* Header */}
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
              {messages.length === 0 && (
                <div className="text-center py-8">
                  ...
                  <h4 className="font-semibold text-gray-800 mb-2">Welcome to LEXA AI!</h4>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <button
                        ...
                        className="block w-full text-left text-sm px-3 py-2 bg-white rounded-lg border border-gray-200 hover:border-purple-400 hover:bg-purple-50 transition-colors"
                      >
                        {suggestion}
                      </button>
                    ))}
              ...
              {isLoading && (
                ...
                >
                  <div className="flex items-center gap-2 px-4 py-2 bg-white rounded-2xl rounded-tl-sm shadow-sm border border-gray-100">
