      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-4 right-4 z-50 w-[380px] max-w-[calc(100vw-32px)] h-[600px] max-h-[calc(100vh-100px)] bg-white dark:bg-gray-900 rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-gray-200 dark:border-gray-700 dark:border-gray-700"
          >
            {/* Header */}
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50 dark:bg-gray-800">
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <button
                        ...
                        className="block w-full text-left text-sm px-3 py-2 bg-white dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-700 dark:border-gray-600 hover:border-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/30 transition-colors dark:text-gray-200"
                      >
                        {suggestion}
                      </button>
                    ))}
                  ...
                  <div className={`flex items-start gap-2 max-w-[85%] ${msg.role === 'user' ? 'flex-row-reverse' : ''}`}>
                    ...
                    <div className={`px-4 py-2 rounded-2xl ${
                      msg.role === 'user' 
                        ...
                        : 'bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 dark:text-gray-200 rounded-tl-sm shadow-sm border border-gray-100 dark:border-gray-800 dark:border-gray-600'
                    }`}>
              ...
              {isLoading && (
                ...
                >
                  <div className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-700 rounded-2xl rounded-tl-sm shadow-sm border border-gray-100 dark:border-gray-800 dark:border-gray-600">
            ...
            {leadScore > 0 && (
              <div className="px-4 py-2 bg-gradient-to-r from-green-50 to-blue-50 border-t border-gray-100 dark:border-gray-800 dark:border-gray-800">
            ...
            {/* Input */}
            <div className="p-4 border-t border-gray-200 dark:border-gray-700 dark:border-gray-700 bg-white dark:bg-gray-900">
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2 border border-gray-200 dark:border-gray-700 dark:border-gray-600 rounded-full focus:outline-none focus:border-purple-400 focus:ring-2 focus:ring-purple-100 dark:focus:ring-purple-900 text-sm bg-white dark:bg-gray-800 dark:text-white"
                  disabled={isLoading}
                />
                <button
                  onClick={sendMessage}
