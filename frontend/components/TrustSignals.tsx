        ...
        <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <div className="space-y-2.5 md:space-y-3">
                {authorities.map((auth, index) => (
                  <div 
                    key={index}
                    className="flex items-center justify-center md:justify-start gap-2 text-gray-700 dark:text-gray-300 dark:text-gray-300"
                  >
          ...
          >
            <div className="text-center">
              ...
              <div className="text-sm md:text-base text-gray-600 dark:text-gray-400 dark:text-gray-400">Luxury Villas</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold mb-1.5 md:mb-2">15+</div>
              <div className="text-sm md:text-base text-gray-600 dark:text-gray-400 dark:text-gray-400">Years in UAE</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold mb-1.5 md:mb-2">24/7</div>
              <div className="text-sm md:text-base text-gray-600 dark:text-gray-400 dark:text-gray-400">Support Available</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold mb-1.5 md:mb-2">CEDIA</div>
              <div className="text-sm md:text-base text-gray-600 dark:text-gray-400 dark:text-gray-400">Certified Team</div>
            </div>
          </motion.div>
