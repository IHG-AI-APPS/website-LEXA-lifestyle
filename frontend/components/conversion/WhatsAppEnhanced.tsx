                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <ArrowRight className="mt-1 h-4 w-4 flex-shrink-0 text-gray-600 opacity-0 transition-all group-hover:translate-x-1 group-hover:text-[#E8DCC8] group-hover:opacity-100" />
                      </div>
                    </button>
                  )
                })}
